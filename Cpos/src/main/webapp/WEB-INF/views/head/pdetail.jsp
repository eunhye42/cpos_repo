...
<section class="py-5">
  ...
  <ul class="list-group">    
    ...
    <li class="list-group-item list-group-item-primary" name="expire_term">유통기간 : ${hvo.expire_term } 일</li>
    <li class="list-group-item list-group-item-primary" name="get_price">도매가 : ${hvo.get_price } 원</li>
    <li class="list-group-item list-group-item-primary" name="sell_price">판매가 : ${hvo.sell_price } 원</li>
